...
### Есть возможность скачать как все файлы проектов архивом через GitHub, так и каждый по отдельности через ссылку на Google Диск. Для второго варианта воспользуйтесь Навигацией по проектам.
...
- [Анализ розничной сети](Ретейл/README.md)
